import { ShieldCheck, MapPin, Phone, Mail, Facebook, Twitter, Instagram, Linkedin, Droplets } from "lucide-react";
    ...
    <footer className="bg-slate-950 text-white pt-24 pb-12 overflow-hidden relative border-t border-indigo-500/20">
      ...
      <div className="container mx-auto px-4 relative z-10 text-nowrap">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            <h4 className="text-[11px] font-black mb-8 uppercase tracking-[0.3em] text-indigo-500 text-nowrap">Plumber NAP</h4>
            <ul className="space-y-6">
              ...
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <a href="tel:8777921410" className="text-sm font-bold text-slate-200 hover:text-indigo-500 transition-colors uppercase tracking-widest leading-none underline decoration-indigo-900 underline-offset-4 text-nowrap">(877) 792-1410</a>
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
