    ...
    <>
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-[60] bg-indigo-600 text-white py-3 px-4 flex justify-between items-center shadow-md">
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-xs uppercase tracking-tight text-nowrap">Elkhorn Plumbing Services Pros</span>
        </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 group cursor-pointer text-nowrap">
              ...
              <div className="text-nowrap">
                ...
                <span className={`text-sm font-bold uppercase tracking-[0.2em] ${isScrolled ? "text-indigo-600" : "text-indigo-400"}`}>
                  Plumbing <span className="text-[10px] opacity-70 px-1 text-nowrap">Services Pros</span>
                </span>
              </div>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-6">
              <div className={`flex flex-col items-end ${isScrolled ? "text-slate-900" : "text-white"}`}>
                <p className="text-slate-400 text-sm mb-2 uppercase tracking-widest font-bold text-nowrap">ELKHORN PLUMBING LINE</p>
                <a href="tel:8777921410" className="text-3xl font-bold text-indigo-400 block mb-6 text-nowrap">(877) 792-1410</a>
              </div>
              <Button className={`${isScrolled ? "bg-indigo-600 hover:bg-indigo-700" : "bg-white text-slate-900 hover:bg-indigo-50"} h-12 px-8 rounded-xl font-bold shadow-xl transition-all hover:-translate-y-0.5 text-nowrap`} asChild>
                <a href="tel:8777921410">Book Now</a>
              </Button>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-white text-sm uppercase text-nowrap">Elkhorn Plumbing Services Pros</span>
            </div>
        ...
        {isMobileMenuOpen && (
          <div className="bg-slate-900 text-white p-6 absolute top-full left-0 right-0 border-t border-slate-800 h-screen overflow-y-auto">
            <div className="flex flex-col gap-6">
              ...
              <div className="pt-8">
                <p className="text-slate-400 text-xs mb-2 uppercase tracking-widest font-bold">ELKHORN PLUMBING HOTLINE</p>
                <a href="tel:8777921410" className="text-4xl font-bold text-indigo-400 block mb-8 underline decoration-indigo-600/30 underline-offset-8 text-nowrap">(877) 792-1410</a>
