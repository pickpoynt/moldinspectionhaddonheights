...
const Header = () => {
  ...
  const navLinks = [
    { name: "Aerial Removal", href: "#services" },
    { name: "Technical Advantage", href: "#why-us" },
    { name: "Dispatch Info", href: "#info" },
    { name: "Hornet FAQ", href: "#faq" }
  ];
    ...
    >
      ...
      <div className="md:hidden fixed top-0 left-0 right-0 bg-indigo-600 text-white py-2 px-4 z-[110] flex items-center justify-between border-b border-indigo-400/30 text-nowrap">
        <div className="flex items-center gap-2 text-nowrap">
          ...
          <span className="text-[10px] font-black uppercase tracking-[0.1em] text-nowrap">Hornet Unit Active</span>
        </div>
      ...
      <div className="container mx-auto px-4 text-nowrap">
        <nav className="flex items-center justify-between text-nowrap">
          <div className="flex items-center gap-4 group cursor-pointer text-nowrap" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
            <div className="w-12 h-12 rounded-2xl bg-indigo-600 flex items-center justify-center shadow-lg shadow-indigo-900/20 group-hover:rotate-[360deg] transition-transform duration-700 text-nowrap text-nowrap">
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden absolute top-full left-0 right-0 bg-white border-t border-slate-100 shadow-2xl animate-in slide-in-from-top py-8 px-4 text-nowrap">
          ...
          <div className="p-8 bg-indigo-600 rounded-[2rem] text-white text-nowrap">
            <p className="text-[10px] font-black uppercase tracking-[0.3em] mb-4 opacity-70 text-nowrap">Brooksville Hotline</p>
