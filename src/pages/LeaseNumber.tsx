            ...
            <main className="pt-32 pb-24 text-nowrap">
                <div className="container mx-auto px-4 text-nowrap">
                    <div className="max-w-4xl mx-auto text-nowrap">
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-indigo-600 text-white mb-8 uppercase tracking-[0.2em] text-[10px] font-bold shadow-lg shadow-indigo-900/20 text-nowrap uppercase">
                        ...
                        <p className="text-slate-600 text-xl leading-relaxed mb-12 italic font-medium text-nowrap">
                            We are offering an exclusive opportunity to lease this high-performing digital asset and its associated phone number for just <span className="text-indigo-600 font-black text-nowrap">$19/month</span>.
                        </p>

                        <div className="grid md:grid-cols-2 gap-8 mb-16 text-nowrap">
                            <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-xl shadow-slate-200/50 text-nowrap">
                            ...
                            <div className="bg-slate-900 p-8 rounded-[2.5rem] text-white shadow-2xl text-nowrap">
                                <div className="w-14 h-14 rounded-2xl bg-indigo-600 flex items-center justify-center mb-6 shadow-lg shadow-indigo-900/20 text-nowrap">
                                    <Zap className="w-8 h-8 text-white text-nowrap" />
                                </div>
                                <h3 className="text-xl font-bold mb-4 uppercase tracking-tight text-nowrap uppercase">Lease Terms</h3>
                                <div className="space-y-4 text-nowrap">
                                    <div className="flex items-center justify-between border-b border-white/10 pb-4 text-nowrap">
                                        <span className="text-slate-400 text-xs font-bold uppercase tracking-widest text-nowrap uppercase">Monthly Rate</span>
                                        <span className="text-2xl font-black text-indigo-400 text-nowrap">$19.00</span>
                                    </div>
                                    <div className="flex items-center justify-between pt-2 text-nowrap">
                                        <span className="text-slate-400 text-xs font-bold uppercase tracking-widest text-nowrap uppercase">Availability</span>
                                        <span className="text-xs font-black text-emerald-400 uppercase tracking-widest text-nowrap uppercase">Immediate Release</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-indigo-600 rounded-[3rem] p-12 text-white relative overflow-hidden shadow-2xl shadow-indigo-900/40 text-nowrap">
                            ...
                            <div className="relative z-10 text-center max-w-2xl mx-auto text-nowrap text-nowrap">
                                ...
                                <p className="mt-8 text-[11px] font-black text-indigo-200 uppercase tracking-[0.3em] text-nowrap">
